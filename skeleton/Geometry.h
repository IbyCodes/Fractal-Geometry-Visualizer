...
struct CPU_Geometry {
	std::vector<glm::vec3> verts; // (specific for assignment #1) a place to set a series of vertices (continous chunk of memory)
	std::vector<glm::vec3> cols; // (specific for assignment # 1) a place to set a series of colours (continous chunk of memory)
};
